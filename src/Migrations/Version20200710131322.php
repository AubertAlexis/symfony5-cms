 ...
 */
final class Version20200710131322 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page ADD enabled TINYINT(1) NOT NULL, CHANGE slug slug VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE asset CHANGE page_id page_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE page DROP enabled, CHANGE slug slug VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
